...
//     try {
//       setError("");
//       await axios.delete(`/menu/${id}`, { withCredentials: true });
//       fetchMenu();
//     } catch (err) {
...
//       if (editItem) {
//         // Update - JSON data
//         response = await axios.put(`/menu/${editItem}`, form, { 
//           withCredentials: true 
//         });
//       } else {
//         // Create - JSON data  
//         response = await axios.post("/menu", form, { 
//           withCredentials: true 
//         });
//       }
...
//         <p className="text-gray-500 mb-4">Please log in to manage menu</p>
//       </div>
//     );
//   }
...
//                 <div className="w-14 h-14 rounded-xl bg-gray-50 flex items-center justify-center text-3xl flex-shrink-0 overflow-hidden">
//                   {item.menuImage ? (
//                     <img 
//                       src={item.menuImage} 
//                       alt={item.name} 
